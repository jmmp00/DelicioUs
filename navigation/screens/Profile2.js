  ...
  return (
    ...
    onPress={() => props.navigation.navigate('Sustainability')}>
      ...
      <TouchableOpacity 
        ...
        onPress={() => props.navigation.navigate('Preferences2')}
        >
